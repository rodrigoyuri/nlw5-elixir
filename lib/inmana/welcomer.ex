defmodule Inmana.Welcomer do
  ...
  # Se o usuario chamar banana e tiver idade 42, ele recebe uma mensagem normal
  # Se o usuario for maior de idade, ele recebe uma mensagem normal
  # Se o usuario for menor de idade, retornamos um erro
  # Temos que tratar o nome do usuario para entretadas erradas, como BaNaNa, BaNaNa \n
